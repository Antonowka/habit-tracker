...
export function howItWorkButton() {
    ...
    const howItWorkText = document.querySelector('.modal-howTo-text') as HTMLElement;
    ...
    const textHowItWork = `
    <p class="subtitle">Habit Tracker works on three principles:</p>
    ...
    <figure class="animation"><img src="./assets/gif/pushHabitButton.gif" alt="pushHabitButton"></figure>
    ...
    <figure class="animation"><img src="./assets/gif/markHabit.gif" alt="markHabit"></figure>
    <p class="subtitle">Why set goals</p>
    ...
    <p class="subtitle">When to make notes</p>
    <p>Create your notes by clicking on "+ New Note".</p>
    <figure class="animation"><img src="./assets/gif/pushNoteButton.gif" alt="pushNoteButton"></figure>
    ...
    howItWorkText.innerHTML = textHowItWork;
}
